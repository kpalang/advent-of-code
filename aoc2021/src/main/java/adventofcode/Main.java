...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("--------------------------");
        System.out.println("Advent of code 2021: Day 11");
        System.out.printf("Part1 -> The total error score is %s%n", day11.part1());
        System.out.printf("Part2 -> The middle score is %s%n", day11.part2());
    }
}
